...
// 7.4 FORMULARIO VALIDACIÓN
   ...
   if(isset($_POST['submit'])){
      ...
      if(!empty($nombre)){ // Anti inyección de código
         ...
         $nombre = htmlspecialchars($nombre); //Caracteres espciales
         $nombre = stripslashes($nombre); //Nos quita estos simbolos
